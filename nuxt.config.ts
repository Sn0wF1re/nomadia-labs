...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      script: [
        {
          ...
          })(window,document,'script','dataLayer','GTM-PRBGV9S6');`,
      ...
      noscript: [
        {
          innerHTML: '<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PRBGV9S6" height="0" width="0" style="display:none;visibility:hidden"></iframe>',
