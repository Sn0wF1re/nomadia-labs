  ...
  >
    <Card class="h-full rounded-sm shadow-lg border-0 bg-white flex flex-col">
      <CardHeader class="bg-teal p-6">
        ...
        <p class="text-xl font-light mt-2 text-white font-playfair">
          Expert Direction
        </p>
      </CardHeader>
      <CardContent class="p-6 bg-white flex-1 flex flex-col justify-between">
        <div class="mb-6">
          <p class="text-sm text-gray-700 mb-4 font-medium font-inter">
            <strong class="text-midnight-blue">Best for:</strong> Those ready to make informed decisions
          </p>
        ...
        <div class="bg-sand-gold/15 p-5 rounded-sm mt-4 border-2 border-sand-gold">
          ...
          <p class="text-sm text-midnight-blue font-semibold font-inter">
            Shortlist, data, and personalized action direction
          </p>
        </div>
        ...
        <PaymentModal :open="showModal" :tier="2" :amount="7500" :onClose="closeModal" />
      </CardContent>
    </Card>
  </Motion>
</template>
